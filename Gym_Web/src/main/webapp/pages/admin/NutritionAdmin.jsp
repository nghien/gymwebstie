												...
												<div class="panel-body">
													<form id="form" enctype="multipart/form-data" id="form"
														...
														<div class="form-group">
															<label class="col-sm-4 control-label"> Tên bài <star>*</star>
															</label>
															<div class="col-sm-7">
																<input class="form-control" name="nutritionName"
																	id="nutritionName" type="text" required="true"
								...
								<div class="card-content">
									...
									<div id="table">
										<table data-toggle="table" class="table" id="bootstrap-table"
											data-url="/SpringRestHibernateExample/getAllNutritions"
